...
This manual is somewhat out-of-date.  Much of what's in here is trustworthy,
but use the system as the source of truth -- =C-h m= is a good place to start.
This manual will be revamped as part of [[https://github.com/vermiculus/magithub/issues/220][#220]].
